...
def cambiar_estado(repo, id: UUID, data: CambiarEstadoRequest,
                   empresa_id: Optional[UUID] = None) -> ObjetivoResponse:
    ...
    if not repo.find_by_id(str(id), empresa_id):
...
def eliminar(repo, id: UUID, empresa_id: Optional[UUID] = None) -> None:
