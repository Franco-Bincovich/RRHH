"""
`empleados.fecha_egreso` sale por la API: en la fila del listado y en el archivo del export.
...
def _fila(idx: int, apellido: str, estado: str, fecha_egreso) -> dict:
