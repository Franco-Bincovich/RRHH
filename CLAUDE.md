...
├── services/            ← 237 archivos de lógica de negocio (263 con submódulos: export/ 8,
...
└── tests/               ← 227 archivos .py: 207 `test_*.py` + 20 helpers `_*.py` (exentos del
...
desarrollo pero **`next build` falla**. `vitest` cubre 1528 tests en 130 archivos, pero **la mayor
...
- **Son 37 barridos estructurales conocidos** (23 backend + 14 front), renumerados el 19/8/2026 —
