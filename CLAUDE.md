...
├── services/            ← 255 archivos de lógica de negocio (283 con submódulos: export/ 10,
...
├── migrations/          ← 120 archivos SQL (000_run_all + 001–122 menos 075–077, que
...
**Migraciones y salud de base.** 120 archivos SQL en `backend/migrations/`. La última ESCRITA es **121**
...
desarrollo pero **`next build` falla**. `vitest` cubre 1700 tests en 151 archivos, pero **la mayor
