...
desarrollo pero **`next build` falla**. `vitest` cubre 1556 tests en 134 archivos, pero **la mayor
...
- **Son 40 barridos estructurales conocidos** (24 backend + 16 front), renumerados el 19/8/2026 —
