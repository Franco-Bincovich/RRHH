...
└── tests/               ← 241 archivos .py: 218 `test_*.py` + 23 helpers `_*.py` (exentos del
...
desarrollo pero **`next build` falla**. `vitest` cubre 1663 tests en 149 archivos, pero **la mayor
